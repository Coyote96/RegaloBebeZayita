const elements = {
  ...
  class Button {
    constructor({ className, action, isLocked }) {
      Object.assign(this, {
      ...
      const handleTap = event => {
        ...
        if (event.type === 'click' && now - this.lastTouchAt < 500) return
        if (event.type === 'touchend') this.lastTouchAt = now
      ...
      this.el.addEventListener('touchend', handleTap, { passive: false })
  ...
  ;['contextmenu', 'selectstart', 'gesturestart'].forEach(eventName => {
